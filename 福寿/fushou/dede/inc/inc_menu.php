...
<m:top item='1_10_7_' name='系统帮助' display='none'>
  <m:item name='更多模板' link='http://www.adminbuy.cn' rank='' target='_blank' />
  <m:item name='技术支持' link='http://www.adminbuy.cn' rank='' target='_blank' />
  <m:item name='仿站业务' link='http://fang.adminbuy.cn/' rank='' target='_blank' />
</m:top>

<m:top item='1_10_7_' name='后台定制/仿站' display='none'>
  <m:item name='QQ：9490489' link=javascript:;' rank='' />>
</m:top>
